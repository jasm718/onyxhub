...
const stats = [
  { value: 2.4, suffix: "M+", label: "集中管理数据", color: "teal" },
  { value: 99.99, suffix: "%", label: "稳定可靠体验", color: "coral" },
  { value: 150, suffix: "+", label: "行业客户选择", color: "gold" },
  { value: 40, suffix: "+", label: "覆盖核心场景", color: "teal" },
]
